...
const footer = `
  ...
  <footer class="border-t border-zinc-200 dark:border-zinc-800 py-8 px-6 bg-zinc-50 dark:bg-zinc-900/50">
    <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
      <p class="text-sm text-zinc-500">© 2024-2026 float-v. Created by Peter Fulle</p>
...
export function generateDocsPage(): string {
  ...
  <div class="flex">
    ...
    <main class="flex-1 max-w-3xl mx-auto px-6 py-12 prose dark:prose-invert">
      ...
      <p class="text-lg text-zinc-600 dark:text-zinc-400 mb-8">Learn how to build modern web applications with float-v</p>
      
      <h2 class="text-2xl font-semibold mt-12 mb-4">Installation</h2>
      <p class="mb-4">Create a new float-v project with a single command:</p>
...
npm run dev</code></pre>
      ...
      <p class="mb-4">float-v uses a file-based routing system. Your project structure looks like this:</p>
...
export function generateLearnPage(): string {
  ...
  <main class="max-w-4xl mx-auto px-6 py-16">
    <div class="text-center mb-16">
      <h1 class="text-4xl sm:text-5xl font-bold mb-4">Learn float-v</h1>
      <p class="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
        Follow our step-by-step tutorial to master float-v and build your first application
      </p>
    </div>
      ...
      <div class="p-6 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            ...
            <p class="text-zinc-600 dark:text-zinc-400 mb-4">Start by creating a new float-v project using the CLI</p>
...
<span class="text-violet-400">export default</span> <span class="text-blue-400">function</span> <span class="text-yellow-300">HomePage</span>() {
  <span class="text-violet-400">return</span> (
    <span class="text-zinc-500">&lt;</span><span class="text-emerald-400">main</span><span class="text-zinc-500">&gt;</span>
      <span class="text-zinc-500">&lt;</span><span class="text-emerald-400">h1</span><span class="text-zinc-500">&gt;</span>Hello, float-v!<span class="text-zinc-500">&lt;/</span><span class="text-emerald-400">h1</span><span class="text-zinc-500">&gt;</span>
...
export function generateExamplesPage(): string {
  ...
  <main class="max-w-6xl mx-auto px-6 py-16">
    ...
    <div class="mt-16 text-center p-8 bg-gradient-to-r from-blue-50 to-violet-50 dark:from-blue-950/30 dark:to-violet-950/30 border border-blue-200 dark:border-blue-800 rounded-2xl">
      ...
      <a href="https://github.com/float-v/float-v" target="_blank" class="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-semibold rounded-xl hover:bg-zinc-800 dark:hover:bg-zinc-100 transition-colors">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/></svg>
        View on GitHub
      </a>
    </div>

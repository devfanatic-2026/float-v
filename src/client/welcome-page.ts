...
<head>
  ...
  <title>Welcome to float-v</title>
...
<body class="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white min-h-screen font-sans transition-colors duration-300">
  ...
  <header class="fixed top-0 left-0 right-0 z-50 border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md">
    <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <span class="font-semibold text-lg">float-v</span>
      ...
      <nav class="hidden sm:flex items-center gap-6">
        ...
        <a href="https://github.com/float-v/float-v" target="_blank" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">GitHub</a>
      </nav>
  ...
  <span class="text-violet-600 dark:text-violet-400">return</span> (
    <span class="text-zinc-500">&lt;</span><span class="text-emerald-600 dark:text-emerald-400">h1</span><span class="text-zinc-500">&gt;</span>Hello, float-v!<span class="text-zinc-500">&lt;/</span><span class="text-emerald-600 dark:text-emerald-400">h1</span><span class="text-zinc-500">&gt;</span>
  );
}</code></pre>
      </div>
    ...
    <div class="max-w-6xl mx-auto">
      <div class="grid grid-cols-1 sm:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="/__learn" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">Learn float-v</a></li>
            ...
            <li><a href="https://github.com/float-v/float-v" target="_blank" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">Blog</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="https://github.com/float-v/float-v" target="_blank" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">GitHub</a></li>
            <li><a href="https://github.com/float-v/float-v/releases" target="_blank" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">Releases</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="https://github.com/float-v/float-v/blob/main/LICENSE" target="_blank" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">MIT License</a></li>
            <li><a href="https://github.com/float-v/float-v" target="_blank" class="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">Contribute</a></li>
          </ul>
        </div>
      ...
      <div class="pt-8 border-t border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p class="text-sm text-zinc-500">
          © 2024-2026 float-v. Created by <span class="text-zinc-700 dark:text-zinc-300 font-medium">Peter Fulle</span>
        </p>
        <div class="flex items-center gap-4">
          ...
          <a href="https://github.com/float-v/float-v" target="_blank" class="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">

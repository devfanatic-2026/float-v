...
<head>
  ...
  <title>Float-V Dev Dashboard</title>
...
<body>
  ...
  <aside class="sidebar">
    <div class="sidebar-header">
      <div class="logo">
        ...
        <div class="logo-text">
          <span class="logo-title">Float-V</span>
  ...
  <main class="main">
    <div class="page-header">
      ...
      <p class="page-subtitle">Monitor your Float-V application in real-time</p>
    </div>
  ...
  return (req: IncomingMessage, res: ServerResponse, next: () => void) => {
    ...
    if (auth) {
      ...
      if (!authHeader || !authHeader.startsWith('Basic ')) {
        res.setHeader('WWW-Authenticate', 'Basic realm="Float-V Dev Dashboard"');
        res.statusCode = 401;
